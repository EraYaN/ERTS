...
\tikzstyle{byte}=[draw, fill=blue!20, minimum width=5cm,node distance=0cm, minimum height=0.5cm,text width=5cm]
\tikzstyle{data}=[byte, fill=red!20]
\tikzstyle{byte_small}=[draw, fill=blue!20, minimum width=1.5cm,node distance=0cm, minimum height=0.5cm,text width=1.5cm]
